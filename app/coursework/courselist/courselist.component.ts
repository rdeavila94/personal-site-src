...
export class CourselistComponent implements OnInit {
  ...
  courses: Course[] = [
    ...
    new Course('Spring Framework 5', 'udemy', 'https://www.udemy.com/spring-framework-5-beginner-to-guru/learn/v4/overview', "Comprehensive course on Spring Framework 5 and Spring Boot 2. Covered the same fundamentals as the previous 'Spring & Hibernate' course above and much more such as: Spring Boot, unit testing (JUnit), continuous integration, Docker, Spring with Mongo. Course topics were meant for covering material that would be most applicable to an industrial setting.", []),
