...
export class CourselistComponent implements OnInit {
  ...
  courses: Course[] = [
    ...
    new Course('Spring Framework 5', 'udemy', 'https://www.udemy.com/spring-framework-5-beginner-to-guru/learn/v4/overview', "Comprehensive course on Spring Framework 5 and Spring Boot 2. Covered many of the same fundamentals as the previous 'Spring & Hibernate' course above but included much more: Spring Boot, unit testing (JUnit), continuous integration, Docker, and Spring with Mongo. Course topics were meant for covering material that would be most applicable to an industrial setting.", []),

    new Course('Technical Communication', 'csulb', 'http://csulb.edu/divisions/aa/catalog/current/cla/english/engl_ud.html', 'Comparison of technical writing for engineers and scientists in to academic writing. Improved my ability to write succinct scientific or business oriented papers.', []),
